...
В последующие разы, когда будете заходить в каталог с проектом из нового окна
эмулятора терминала, выполняйте команду

```shell
pipenv shell
```

для активации `virtualenv`, в который был установлен `ansible`.
